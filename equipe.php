  ...
  <div class="main main-raised">
    <div class="container">
      <div class="section text-center">
        <h2 class="title">Aqui está a nossa equipe!</h2>
        <div class="team">
          <div class="row">
            <div class="col-md-4">
    ...
    <div class="section section-contacts">
      <div class="row">
        <div class="col-md-8 ml-auto mr-auto">
          <h2 class="text-center title">Trabalhe Conosco</h2>
          <h4 class="text-center description">Divida os detalhes do trabalho do seu produto ou agência em partes. Escreva algumas linhas sobre cada uma delas e entre em contato conosco sobre qualquer colaboração adicional. Responderemos em algumas horas.</h4>
